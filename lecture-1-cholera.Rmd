...
# Snow took advantage of these spatial differences in .alert[exposure] to conduct a natural experiment

- Snow death register data into sub-districts of South London organized by water supplier.
...
- Concluded that it had to be due to contamination of water from sewage, closing the fecal-oral loop.
...
3. What challenges or risks might be associated with the hotspot-focused approach?
